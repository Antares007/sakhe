...
import { record, type, lambda, unit } from "./fable-library.2.1.0-beta-006/Reflection";
import { return$0027 as return$00240027 } from "./disposable";
import { run } from "./scheduler";
import { run as run$$1 } from "./stream";
export const Sink$00601 = declare(function Sakhe_Default_Sink(arg1, arg2, arg3) {
  this.next = arg1;
  this.complete = arg2;
  this.error = arg3;
}, Record);
export function Sink$00601$reflection($gen$$1) {
  return record("Sakhe.Default.Sink`1", [$gen$$1], Sink$00601, () => [["next", lambda($gen$$1, unit)], ["complete", lambda(unit, unit)], ["error", lambda(type("System.Exception"), unit)]]);
}
...
export function subscribe(sink, s) {
  return run$$1(scheduler, function (_arg1) {
    switch (_arg1.tag) {
      case 1:
        {
