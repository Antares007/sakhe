...
import { union, type, float64 } from "./fable-library.2.1.0-beta-006/Reflection";
import { P$$$run as P$0024$0024$0024run } from "./pith";
import { O } from "./scheduler";
import { append, return$0027 as return$00240027, empty as empty$$1 } from "./disposable";
import { iterate } from "./fable-library.2.1.0-beta-006/Seq";
import { partialApply } from "./fable-library.2.1.0-beta-006/Util";
import { map as map$$5 } from "./fable-library.2.1.0-beta-006/Array";
import { value as value$$5, some } from "./fable-library.2.1.0-beta-006/Option";
export const O$00601 = declare(function Sakhe_Stream_O(tag, name, ...fields) {
  Union.call(this, tag, name, ...fields);
}, Union);
export function O$00601$reflection($gen$$35) {
  return union("Sakhe.Stream.O`1", [$gen$$35], O$00601, () => [["Event", [float64, $gen$$35]], ["End", [float64]], ["Error", [float64, type("System.Exception")]]]);
}
export function run(run$$1, o, _arg1) {
  const io = _arg1;
  return P$0024$0024$0024run(o, io(run$$1));
}
export function pair(a, b) {
  return [a, b];
}
export function at(d, a$$1) {
  return function (run$$2) {
    return function (o$$1) {
      ...
      return run$$2(new O(2, "Delay", $arg$$1[0], $arg$$1[1]));
    };
  };
}
export function fromArray(arr) {
  return function (run$$3) {
    return function (o$$2) {
      ...
      return run$$3(new O(2, "Delay", $arg$$3[0], $arg$$3[1]));
    };
  };
}
export function now(a$$3) {
  return at(0, a$$3);
}
export function on(event, et) {
  return function (schedule) {
    return function (o$$3) {
      let d$$1 = empty$$1;
      const d$0027 = schedule(new O(1, "Origin", function (t$0027) {
        return function (o$0027) {
          const listener = function listener(e) {
            schedule(new O(1, "Origin", function (t$$2) {
          ...
          d$$1 = return$00240027(function () {
            et.removeEventListener(event, listener);
          });
        };
      }));
      return append(d$0027, return$00240027(function () {
        d$$1.Dispose();
      }));
    };
  };
}
export function periodic(period, a$$4) {
  return function (run$$4) {
    return function (o$$4) {
      const schedule$$1 = function schedule$$1(t$$3) {
        return function (o$0027$$1) {
          try {
            ...
            o$0027$$1(new O(2, "Delay", period, schedule$$1));
          } catch (err$$2) {
      ...
      return run$$4(new O(2, "Delay", 0, schedule$$1));
    };
  };
}
...
export function map(f$$2, _arg1$$4) {
  const io$$1 = _arg1$$4;
  return function (run$$6) {
    return function (o$$5) {
      return P$0024$0024$0024run(function (_arg2) {
        switch (_arg2.tag) {
          case 1:
            {
...
export function filter(f$$3, _arg1$$5) {
  const io$$2 = _arg1$$5;
  return function (run$$7) {
    return function (o$$7) {
      return P$0024$0024$0024run(function (_arg2$$1) {
        switch (_arg2$$1.tag) {
          case 1:
            {
...
export function fold(f$$4, s$0027, _arg1$$6) {
  const io$$3 = _arg1$$6;
  return function (run$$8) {
    return function (o$$9) {
      let s$$1 = s$0027;
      return P$0024$0024$0024run(function (_arg2$$2) {
        switch (_arg2$$2.tag) {
          case 1:
            {
...
export function tap(f$$5, _arg1$$7) {
  const io$$4 = _arg1$$7;
  return function (run$$9) {
    return function (o$$11) {
      return P$0024$0024$0024run(function (_arg2$$3) {
        if (_arg2$$3.tag === 0) {
...
export function take(n, _arg1$$8) {
  const io$$5 = _arg1$$8;
  return function (run$$10) {
    return function (o$$13) {
      let i$$1 = 0;
      let d$$2 = empty$$1;
      d$$2 = P$0024$0024$0024run(function (_arg2$$4) {
        switch (_arg2$$4.tag) {
          case 1:
            {
...
export function merge(_arg2$$5, _arg1$$9) {
  const a$$10 = _arg2$$5;
  const b$$3 = _arg1$$9;
  return function (run$$11) {
    return function (o$$15) {
      const map$$1 = new Map([]);
      const disposable = return$00240027(function () {
      ...
      map$$1.set(0, P$0024$0024$0024run(partialApply(1, o$0027$$2, [0]), a$$10(run$$11)));
      map$$1.set(1, P$0024$0024$0024run(partialApply(1, o$0027$$2, [1]), b$$3(run$$11)));
      return disposable;
    };
  };
}
export function mergeArray(ios) {
  return function (run$$12) {
    return function (o$$16) {
      const map$$2 = new Map([]);
      const disposable$$1 = return$00240027(function () {
      ...
      for (let i$$2 = 0; i$$2 <= ios.length - 1; i$$2++) {
        const io$$6 = ios[i$$2];
        map$$2.set(i$$2, P$0024$0024$0024run(partialApply(1, o$0027$$3, [i$$2]), io$$6(run$$12)));
      }
...
export function combineArray(ios$$1) {
  return function (run$$13) {
    return function (o$$17) {
      const values = map$$5(function mapping(_arg1$$11) {
        return null;
      }, ios$$1, Array);
      let allFired = false;
      const map$$3 = new Map([]);
      const disposable$$2 = return$00240027(function () {
        iterate(function (key$$2) {
          ...
          default:
            {
              ...
              if (allFired) {
                const $arg$$28 = [t$$21, map$$5(function mapping$$1(o$$19) {
                  return value$$5(o$$19);
                }, values, Array)];
      ...
      for (let i$$3 = 0; i$$3 <= ios$$1.length - 1; i$$3++) {
        ...
        map$$3.set(i$$3, P$0024$0024$0024run(partialApply(1, o$0027$$4, [i$$3]), io$$7(run$$13)));
      }
...
export function join(_arg1$$13) {
  const io$$8 = _arg1$$13;
  return function (run$$14) {
    return function (o$$20) {
      let i$$4 = 0;
      const map$$4 = new Map([]);
      const disposable$$3 = return$00240027(function () {
        iterate(function (key$$3) {
      ...
      const index$$1 = i$$4 | 0;
      i$$4 = i$$4 + 1;
      const d$$4 = P$0024$0024$0024run(function (_arg2$$6) {
        switch (_arg2$$6.tag) {
          case 1:
            {
          ...
          default:
            {
              ...
              const index$$2 = i$$4 | 0;
              i$$4 = i$$4 + 1;
              const d$$3 = P$0024$0024$0024run(function (_arg3$$1) {
                switch (_arg3$$1.tag) {
                  case 1:
                    {
...
export function bind(f$$10, io$$10) {
