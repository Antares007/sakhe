...
function Pith$$$filter(f$$2, _arg1$$1) {
  const p$$1 = _arg1$$1;
  return function (o) {
...
function Pith$$$filterMap(f$$3, _arg1$$2) {
  const p$$2 = _arg1$$2;
  return function (o$$1) {
...
function Pith$$$map(f$$4, g, _arg1$$3) {
  const p$$3 = _arg1$$3;
  return function (o$$2) {
    g(p$$3(function ($arg$$4) {
      o$$2(f$$4($arg$$4));
    }));
  };
}

function Pith$$$bind(f$$5, _arg1$$4) {
  const p$$4 = _arg1$$4;
  return function (o$$3) {
    const a$$5 = p$$4(o$$3);
    const p$$5 = f$$5(a$$5);
...
function Pith$$$run(_arg2, _arg1$$5) {
  const p$$6 = _arg1$$5;
  return p$$6(_arg2[0]);
}