...
function find(predicate$$9, array$$49) {
...
function tryFind(predicate$$11, array$$51) {
  return array$$51.find(predicate$$11);
}

function findIndex(predicate$$13, array$$53) {
  var index;
...
function tryFindIndex(predicate$$15, array$$55) {
  var index$$2;
...
function pick(chooser, array$$57) {
...
function tryPick(chooser$$1, array$$58) {
...
function findBack(predicate$$17, array$$59) {
...
function tryFindBack(predicate$$18, array$$60) {
  const loop$$4 = function loop$$4(i$$26) {
    loop$$4: while (true) {
      if (i$$26 < 0) {
        return null;
      } else if (predicate$$18(array$$60[i$$26])) {
        return (0, _Option.some)(array$$60[i$$26]);
      } else {
        i$$26 = i$$26 - 1;
        continue loop$$4;
      }
...
function findIndexBack(predicate$$19, array$$61) {
...
function tryFindIndexBack(predicate$$20, array$$62) {
...
function isEmpty(array$$69) {
  return array$$69.length === 0;
}

function forAll(predicate$$21, array$$70) {
  return array$$70.every(predicate$$21);
}

function permute(f$$8, array$$72) {
...
function chunkBySize(chunkSize, array$$77) {
  if (chunkSize < 1) {
...
function splitAt(index$$4, array$$80) {
  if (index$$4 < 0) {
...
function tryHead(array$$85) {
  if (array$$85.length === 0) {
    return null;
  } else {
    return (0, _Option.some)(array$$85[0]);
  }
}

function tail(array$$86) {
...
function item(index$$5, array$$88) {
  return array$$88[index$$5];
}

function tryItem(index$$6, array$$89) {
  if (index$$6 < 0 ? true : index$$6 >= array$$89.length) {
    return null;
  } else {
    return (0, _Option.some)(array$$89[index$$6]);
  }
}

function foldBackIndexed(folder$$6, array$$90, state$$10) {
  return array$$90.reduceRight(function folder$$7(acc$$4, x$$15, i$$43) {
    return folder$$6(i$$43, x$$15, acc$$4);
  }, state$$10);
}

function foldBack(folder$$8, array$$92, state$$12) {
...
function reduce(reduction, array$$94) {
...
function reduceBack(reduction$$2, array$$96) {
...
function exists(predicate$$25, array$$99) {
