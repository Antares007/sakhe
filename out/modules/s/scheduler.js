...
import { empty as empty$$1, append as append$$1, return$0027 as return$00240027$$1 } from "./disposable";
...
function setNextRun(nextArrival$$1, scheduler$$1) {
  ...
  const task = return$00240027(function (_arg1$$1) {
    if (_arg1$$1.tag === 1) {
...
export function schedule(delay$$1, period$$2, task$$5, scheduler$$4) {
  ...
  return return$00240027$$1(function () {
    const f$$8 = taskD$$1.contents;
    f$$8();
    const f$$9 = removeD$$1.contents;
    f$$9();
  });
}