...
import { Timeline$$$add as Timeline$0024$0024$0024add, Timeline$$$removeTasks as Timeline$0024$0024$0024removeTasks, Timeline$$$nextArrival as Timeline$0024$0024$0024nextArrival, Timeline$$$isEmpty as Timeline$0024$0024$0024isEmpty, Timeline$$$empty as Timeline$0024$0024$0024empty } from "./timeline";
import { compare } from "../fable-core.2.0.0-beta-003/Util";
import { empty, append as append$$1, return$0027 as return$00240027$$1, dispose } from "./disposable";
...
export function return$0027(timer, clock) {
  return [new FSharpRef(null), timer, clock, Timeline$0024$0024$0024empty()];
}
...
function scheduleNextRun(scheduler) {
  ...
  if (Timeline$0024$0024$0024isEmpty(timeline)) {} else {
    const nextArrival = Timeline$0024$0024$0024nextArrival(timeline);
...
function setNextRun(nextArrival$$1, scheduler$$1) {
  ...
  return setTimer(return$00240027(function (_arg1) {
    if (_arg1.tag === 1) {
      ...
      const d = run(Timeline$0024$0024$0024removeTasks(now$$1(clock$$1), timeline$$1));
      d;
...
function reschedule(scheduler$$2) {
  ...
  if (Timeline$0024$0024$0024isEmpty(timeline$$2)) {
...
function add(time, period, task, taskD, removeD, scheduler$$3) {
  ...
  removeD.contents = append$$1(Timeline$0024$0024$0024add(time, task$$3, timeline$$3), return$00240027$$1(function () {
...
export function schedule(delay, period$$2, task$$4, scheduler$$4) {
  ...
  const removeD$$1 = new FSharpRef(empty);
  const taskD$$1 = new FSharpRef(empty);
