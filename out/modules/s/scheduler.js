import { Time$002EDelayModule$$$fromTo as Time$0024002EDelayModule$0024$0024$0024fromTo, Time$$$add as Time$0024$0024$0024add, Clock$$$now as Clock$0024$0024$0024now } from "./clock";
...
export function schedule(delay, period, task, _arg1) {
  const taskTime = Time$0024$0024$0024add(Clock$0024$0024$0024now(_arg1[2]), delay);
