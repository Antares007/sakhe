...
function now(a$$1) {
  return new T$00601(0, "Stream", function (tupledArg$$11) {
    return (0, _scheduler.schedule)(null, null, (0, _task.return$0027)(function (_arg1$$4) {
      if (_arg1$$4.tag === 1) {
        const t$$5 = _arg1$$4.fields[0][0];
        const err$$2 = _arg1$$4.fields[1];
        (0, _sink.Send$$$error)(t$$5, err$$2, tupledArg$$11[0]);
        return null;
      } else {
        const t$$4 = _arg1$$4.fields[0][0];
        const s$$2 = _arg1$$4.fields[0][1];
        (0, _sink.Send$$$event)(t$$4, a$$1, tupledArg$$11[0]);
        (0, _sink.Send$$$end$0027)(t$$4, tupledArg$$11[0]);
        return null;
      }
    }), tupledArg$$11[1]);
  });
...
function at(delay$$3, a$$2) {
  return new T$00601(0, "Stream", function (tupledArg$$12) {
    return (0, _scheduler.schedule)(delay$$3, null, (0, _task.return$0027)(function (_arg1$$5) {
      if (_arg1$$5.tag === 1) {
        const t$$7 = _arg1$$5.fields[0][0];
        const err$$3 = _arg1$$5.fields[1];
        (0, _sink.Send$$$error)(t$$7, err$$3, tupledArg$$12[0]);
        return null;
      } else {
        const t$$6 = _arg1$$5.fields[0][0];
        const s$$3 = _arg1$$5.fields[0][1];
        (0, _sink.Send$$$event)(t$$6, a$$2, tupledArg$$12[0]);
        (0, _sink.Send$$$end$0027)(t$$6, tupledArg$$12[0]);
        return null;
      }
    }), tupledArg$$12[1]);
  });
...
function periodic(period$$4) {
  return new T$00601(0, "Stream", function (tupledArg$$13) {
    return (0, _scheduler.schedule)(null, period$$4, (0, _task.return$0027)(function (_arg1$$6) {
      if (_arg1$$6.tag === 1) {
        const t$$9 = _arg1$$6.fields[0][0];
        const err$$4 = _arg1$$6.fields[1];
        (0, _sink.Send$$$error)(t$$9, err$$4, tupledArg$$13[0]);
        return null;
      } else {
        const t$$8 = _arg1$$6.fields[0][0];
        const s$$4 = _arg1$$6.fields[0][1];
        (0, _sink.Send$$$event)(t$$8, null, tupledArg$$13[0]);
        return null;
      }
    }), tupledArg$$13[1]);
  });
...
function throwError(err$$5) {
  return new T$00601(0, "Stream", function (tupledArg$$14) {
    return (0, _scheduler.schedule)(null, null, (0, _task.return$0027)(function (_arg1$$7) {
      if (_arg1$$7.tag === 1) {
        const t$$11 = _arg1$$7.fields[0][0];
        const err$$6 = _arg1$$7.fields[1];
        throw err$$6;
        return null;
      } else {
        const t$$10 = _arg1$$7.fields[0][0];
        const s$$5 = _arg1$$7.fields[0][1];
        (0, _sink.Send$$$error)(t$$10, err$$5, tupledArg$$14[0]);
        return null;
      }
    }), tupledArg$$14[1]);
  });
