...
const Test2 = exports.Test2 = function (__exports) {
  ...
  const patternInput_148_6 = ($var40 => ($var39 => tree(_s.S.now($var39)))(function (arg0_2) {
    return arg0_2;
  }($var40)))(function (o_2) {
  ...
  const rs = __exports.rs = patternInput_148_6[0];
  const ps = __exports.ps = patternInput_148_6[1];
