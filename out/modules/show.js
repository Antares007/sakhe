          ...
          return builder__2.Delay(function () {
            return builder__2.Combine(builder__2.Yield(u("A")), builder__2.Delay(function () {
              return builder__2.Yield(function (builder__3) {
                return (0, _state.Of)(new _update.UpdateMonad(0, s_6 => {
                  const patternInput_17 = new _update.UpdateMonad(0, _arg1_5 => [_state.StateUpdate.Unit, null]).data(s_6);

                  const patternInput_18 = ($var10 => (arg00__4 => (0, _state.valueOf)(arg00__4))(function () {
                    return (0, _state.Of)(new _update.UpdateMonad(0, s_5 => {
                      const patternInput_14 = (0, _state.get)().data.data(s_5);

                      const patternInput_15 = ($var9 => (arg00__3 => (0, _state.valueOf)(arg00__3))(function (_arg1) {
                        return (0, _state.Of)(new _update.UpdateMonad(0, s_4 => {
                          const patternInput_11 = (_arg1.tail != null ? (0, _state.Of)(new _update.UpdateMonad(0, s_1 => {
                            const patternInput_2 = (0, _state.set)(new _List2.default(_arg1.head + 1, _arg1)).data.data(s_1);

                            const patternInput_3 = ($var6 => (arg00_ => (0, _state.valueOf)(arg00_))(function () {
                              return (0, _state.Of)(new _update.UpdateMonad(0, _arg1_1 => [_state.StateUpdate.Unit, null]));
                          ...
                          })) : (0, _state.Of)(new _update.UpdateMonad(0, s_2 => {
                            const patternInput_5 = (0, _state.set)((0, _List.ofArray)([1])).data.data(s_2);

                            const patternInput_6 = ($var7 => (arg00__1 => (0, _state.valueOf)(arg00__1))(function () {
                              return (0, _state.Of)(new _update.UpdateMonad(0, _arg1_2 => [_state.StateUpdate.Unit, null]));
                          ...
                          const patternInput_12 = (() => (0, _state.Of)(new _update.UpdateMonad(0, s_3 => {
                            const patternInput_8 = new _update.UpdateMonad(0, _arg1_4 => [_state.StateUpdate.Unit, null]).data(s_3);

                            const patternInput_9 = ($var8 => (arg00__2 => (0, _state.valueOf)(arg00__2))(function () {
                              return (0, _state.Of)(new _update.UpdateMonad(0, _arg1_3 => [_state.StateUpdate.Unit, "l" + (0, _String.toText)((0, _String.printf)("%A"))(_arg1)]));
                            }($var8)))();
